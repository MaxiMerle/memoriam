 ...
 */
final class Version20190525181137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet_client ADD nom_defunt VARCHAR(255) NOT NULL, ADD prenom_defunt VARCHAR(255) NOT NULL, ADD date_naissance_defunt VARCHAR(255) NOT NULL, ADD date_mort_defunt VARCHAR(255) NOT NULL, ADD description_defunt VARCHAR(255) DEFAULT NULL');
